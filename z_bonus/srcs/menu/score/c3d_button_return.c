...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/23 16:08:08 by lgiband           #+#    #+#             */
/*   Updated: 2022/10/23 16:17:33 by lgiband          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	return_event(int button, int x, int y, t_game *game)
{
	(void)x;
	(void)y;
	if (button == 1)
...
t_dict	*init_return_button(t_game *game)
{
	...
	box->box.x = 20;
	box->box.y = 20;
	ft_strlcpy(box->box.description, "Return", 7);
	...
	box->box.mouse_release = return_event;
