...
/*   Updated: 2022/09/19 15:05:12 by lgiband          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_color(char *line)
{
	...
	if (ft_iscolor(split[0]) == 0 || ft_iscolor(split[1]) == 0 || ft_iscolor(split[2]) == 0)
		return (ft_free_tab(split), -1);
	color = ft_atoi(split[0]) * 256 * 256 + ft_atoi(split[1]) * 256 + ft_atoi(split[2]);
